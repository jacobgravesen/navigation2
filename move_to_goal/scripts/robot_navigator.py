...
class BasicNavigator(Node):
    ...
    def createSubscriptions(self, namespace):
        ...
        self.compute_path_to_pose_client = ActionClient(self, ComputePathToPose, namespace + 'compute_path_to_pose')
    ...
    def waitUntilNav2Active(self, namespace):
        ...
        self._waitForInitialPose(namespace)
        self._waitForNodeToActivate(namespace + 'bt_navigator')
    ...
    def lifecycleStartup(self, namespace):
    ...
    def lifecycleShutdown(self, namespace):
    ...
    def _waitForInitialPose(self, namespace):
        while not self.initial_pose_received:
            self.info('Setting initial pose')
            self._setInitialPose()
            self.info('Waiting for ' + namespace + 'amcl_pose to be received')
